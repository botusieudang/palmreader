...
import type { PalmLineSection, PalmLineSectionId } from '../types/palmQuiz';
import { Colors } from '../constants/theme';

interface Props {
  sections: PalmLineSection[];
  activeSection: PalmLineSectionId;
  answeredCounts: Record<PalmLineSectionId, number>;
  onSelectSection: (id: PalmLineSectionId) => void;
}

export default function PalmLineSelector({
  sections,
  activeSection,
  answeredCounts,
  onSelectSection,
